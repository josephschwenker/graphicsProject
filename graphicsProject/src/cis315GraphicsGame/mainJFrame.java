...
/**
 * @author Joseph Schwenker, Arthur Manning, Omar Alsayar
 * 
 *         
 * This is an extension of an existing drawing program. Three additional shapes
 * were added: Rectangle, Triangle, and Rounded Rectangle. Java already
 * possessed libraries for two of these, but Triangle needed to be implemented
